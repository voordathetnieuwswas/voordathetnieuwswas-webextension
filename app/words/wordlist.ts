...
export const weedCutterWords: DynamicWordList = [
    ...
    /raad|raadsbesluit|raadsdebat|wethouder|jaarvergadering/,
...
export const dynamicWords: DynamicWordList = [
    ...
    /(?:grens|plafond|maximum|prijzen|prijs|verbinding(?:en)?|meters?|feest(?:en)?|vergadering(?:en)?|dossiers?|debat(ten)?)$/, // ends with
    /^[an]\d{1,3}$/, // autowegen
];
